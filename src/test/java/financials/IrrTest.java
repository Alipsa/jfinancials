...
public class IrrTest {
  ...
  /**
   * The values we match up with is taken from the Excel sheet "Calculation loan agreement.xlsx" in
   * the doc folder.
   */
  @Test
  ...
  void testFromPaymentPlan() {
    ...
    assertEquals(
        internalReturn, irr(paymentPlan), "irr from PaymentPlan and from cashflow list differs");
  }

  @Test
  void testNpv() {
    assertEquals(
        5908.8656360761, npv(new double[] {-123400, 36200, 54800, 48100}, 0.035), 0.0000000001);
